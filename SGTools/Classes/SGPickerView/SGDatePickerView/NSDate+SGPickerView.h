...
/** yyyy */
+ (nullable NSDate *)setYear:(NSInteger)year SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");
/** yyyy-MM */
+ (nullable NSDate *)setYear:(NSInteger)year month:(NSInteger)month SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");
/** yyyy-MM-dd */
+ (nullable NSDate *)setYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");
/** yyyy-MM-dd HH:mm */
+ (nullable NSDate *)setYear:(NSInteger)year month:(NSInteger)month day:(NSInteger)day hour:(NSInteger)hour minute:(NSInteger)minute SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");
/** MM-dd HH:mm */
+ (nullable NSDate *)setMonth:(NSInteger)month day:(NSInteger)day hour:(NSInteger)hour minute:(NSInteger)minute SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");
/** MM-dd */
+ (nullable NSDate *)setMonth:(NSInteger)month day:(NSInteger)day SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");
/** HH:mm */
+ (nullable NSDate *)setHour:(NSInteger)hour minute:(NSInteger)minute SGPickerViewDeprecated("过期提醒：请使用带br前缀的方法");

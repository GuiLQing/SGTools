...
typedef void(^BRAddressResultBlock)(SGProvinceModel *province, SGCityModel *city, SGAreaModel *area);
typedef void(^BRAddressCancelBlock)(void);

@interface SGAddressPickerView : SGBaseView

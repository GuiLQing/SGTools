...
@interface SGCollectionViewFlowLayout () {
    CGFloat _sumCellWidth ; //在居中对齐的时候需要知道这行所有cell的宽度总和
}
...
-(instancetype)init {
    return [self initWithType:SGAlignWithCenter betweenOfCell:5.0];
}

...
- (void)layoutAnswerView {
    ...
    [self.lookAnswerBtn setImage:[UIImage imageNamed:@"sg_dictation_icon_lookAnswer_up"] forState:UIControlStateNormal];
    [self.lookAnswerBtn setImage:[UIImage imageNamed:@"sg_dictation_icon_lookAnswer_down"] forState:UIControlStateSelected];

...
/** Animation object used by SGCheckBox to generate animations.
 */
@interface SGAnimationManager : NSObject

/** The duration of the animation created by the SGAnimationManager object.
 */
@property (nonatomic) CGFloat animationDuration;

/** Designated initializer.
 * @param animationDuration The duration of the animations created with the SGAnimationManager object.
 * @return Returns the a fully initialized SGAnimationManager object.
 */

...
/** The SGAnimationManager object used to generate animations.
 */
@property (strong, nonatomic) SGAnimationManager *animationManager;

/** The SGPathManager object used to generate paths.
 */
@property (strong, nonatomic) SGPathManager *pathManager;
...
- (void)commonInit {
    ...
    _onAnimationType = SGAnimationTypeStroke;
    _offAnimationType = SGAnimationTypeStroke;
...
- (void)initPathManager {
    _pathManager = [SGPathManager new];
...
- (void)initAnimationManager {
    _animationManager = [[SGAnimationManager alloc] initWithAnimationDuration:_animationDuration];
}
...
- (void)setBoxType:(SGBoxType)boxType {
    _boxType = boxType;
...
- (void)setOffAnimationType:(SGAnimationType)offAnimationType {
...
- (void)addOnAnimation {
    ...
    switch (self.onAnimationType) {
        ...
        case SGAnimationTypeBounce: {
            CGFloat amplitude = (self.boxType == SGBoxTypeSquare) ? 0.20 : 0.35;
